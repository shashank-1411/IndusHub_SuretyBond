          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <div className="text-center sm:text-left">
              ...
              <p className="mt-1 text-xs text-slate-600">
                Submit via WhatsApp or email directly to <a href="mailto:pravin@indushub.in" className="font-semibold text-[#cf6734] underline">pravin@indushub.in</a>
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <a
                href="mailto:pravin@indushub.in?subject=Surety%20Bond%20Quotation%20Documents"
                className="group flex shrink-0 items-center gap-2 rounded-lg bg-[#cf6734] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#b45828]"
              >
                <svg
                  aria-hidden="true"
                  viewBox="0 0 24 24"
                ...
                <span>Email Documents (pravin@indushub.in)</span>
              </a>
              <button
